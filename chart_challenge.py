...
st.markdown(
    "I could have shared a static image only, but then y'all wouldn't have seen the super cool interactivity of Plotly Express's 3-D scatterplot. You can zoom in, out, pan around the view, and see each mark from all angles. Hover to view tooltips. This data is from the '2021' Data Visualization Society State of the Industry Survey.")
