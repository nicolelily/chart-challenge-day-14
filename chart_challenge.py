...
st.markdown(
    ...
    "This data is from the 2021 Data Visualization Society State of the Industry Survey. Learn more and see the full dataset \n"
    "(here)[https://www.datavisualizationsociety.org/survey]"
